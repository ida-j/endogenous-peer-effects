...
filename='h4_hermite_results_x1x2';
filename2='h4_hermite_sizes_x1x2';
filename3='h4_hermite_variances_x1x2';
...
variances = cell(size(Designs,1),size(Kn_values,2),size(theta_y_values,2),size(N_values,2));
av_net = zeros(1,2);
...
%% testing
%null = [thetahat0   thetahat2 thetahat_H]-[theta_y   theta_y theta_y; 5 5 5; 5 5 5];

%vars=[sqrt(diag(V0)) sqrt(diag(V2)) sqrt(diag(VH))];

null = [thetahat_lc   thetahat2 thetahat]-[theta_y   theta_y theta_y; 5 5 5; 5 5 5];

vars=[sqrt(diag(V_lc)) sqrt(diag(V2)) sqrt(diag(V))];
...
%delete(ParallelPool);
        ...
        %---------------------------------------------------------%
        all_estimates=[estimates0  estimates2 estimates_true]; % B x (3x3=9)

        design_av=[mean(MC_Results_design)];
        
   results(d,Kn_val,theta_y_val,N_val)={[all_estimates;[design_av 0 0]]};
   sizes(d,Kn_val,theta_y_val,N_val)={test};
      variances(d,Kn_val,theta_y_val,N_val)={vars_b};

                end %theta_y 
                
               
    end  % end Kn
        av_net(N_val) = mean(av);
    end  % N


save(filename,'results');
save(filename2,'sizes');
save(filename3, 'variances');
telapsed = toc(tstart);
...
d=8;
    ...
    for Kn_val=1:size(Kn_values,2)  
       ...
       filename=['MC_K_' num2str(Kn) '_sig_' num2str(sig)  '_kappa_' num2str(kappa)  '_h4_hermite_sparse_5.tex'];
% beta values 
...
mean12=mean(r12); std12=std(r12); median12=median(r12);  iqr12=iqr(r12);
 ...
 % kappa1  
mat11=[(mean11(1)-b1)    (mean11(4)-b1)     (mean11(7)-b1)     ;  % beta
       std11(1)          std11(4)           std11(7)                ;
       t11(1,1)         t11(1,2)            t11(1,3)            ;
       iqr11(1)          iqr11(4)            iqr11(7)               ;
       
     (mean11(2)-5)    (mean11(5)-5)     (mean11(8)-5)      ; 
     std11(2)          std11(5)           std11(8)            ;
       t11(2,1)         t11(2,2)            t11(2,3)          ;
     iqr11(2)          iqr11(5)            iqr11(8)            ;
       
      (mean11(3)-5)    (mean11(6)-5)     (mean11(9)-5)        ; 
      std11(3)          std11(6)           std11(9)             ;
       t11(3,1)         t11(3,2)            t11(3,3)      ;
      iqr11(3)          iqr11(6)            iqr11(9)        ];
       
       
% kappa2       
mat12=[(mean12(1)-b1)    (mean12(4)-b1)     (mean12(7)-b1)   ;  % beta
       std12(1)          std12(4)           std12(7)            ;
       t12(1,1)         t12(1,2)            t12(1,3)         ;
       iqr12(1)          iqr12(4)            iqr12(7)            ;
       
     (mean12(2)-5)    (mean12(5)-5)     (mean12(8)-5)      ; 
     std12(2)          std12(5)           std12(8)           ;
       t12(2,1)         t12(2,2)            t12(2,3)         ;
     iqr12(2)          iqr12(5)            iqr12(8)           ;
       
      (mean12(3)-5)    (mean12(6)-5)     (mean12(9)-5)       ; 
      std12(3)          std12(6)           std12(9)            ;
       t12(3,1)         t12(3,2)            t12(3,3)        ;
      iqr12(3)          iqr12(6)            iqr12(9)       ];
...
fprintf(FID, '\\begin{table}\\caption{\\footnotesize {\\bf Design A2,  Hermite Polynomial Sieve}: Parameter values across %.0f MC replications with $K_N=%.0f$} \n',B,Kn);
   
fprintf(FID,'\\begin{threeparttable} \n');
fprintf(FID, '\\centering \\footnotesize\n');
fprintf(FID, '\\scalebox{1}{\\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}\\hline \n');

%% b1

fprintf(FID,'\\cellcolor{yellow}$N$&\\multicolumn{3}{|c|}{\\cellcolor{yellow}$%.3f$}&\\multicolumn{3}{|c|}{\\cellcolor{yellow}$%.3f$}&\\\\\\hline \n',N1,N2);

fprintf(FID,'CF&$(0)$&$(1)$&$(2)$& $(0)$ &$(1)$&$(2)$&\\\\\\hline \n');

% beta

fprintf(FID,'\\multirow{4}{*}{$\\beta_1=%.2f$}& %.3f & %.3f &%.3f &%.3f &%.3f &%.3f& \\textit{mean bias} \\\\ \n',b1,mat1(1,1),mat1(1,2),mat1(1,3),mat1(1,4),mat1(1,5),mat1(1,6));

fprintf(FID,'&(%.3f )&(%.3f )&(%.3f )&(%.3f )&(%.3f )&(%.3f )&\\textit{std}\\\\ \n',mat1(2,1),mat1(2,2),mat1(2,3),mat1(2,4),mat1(2,5),mat1(2,6));

fprintf(FID,'& %.3f & %.3f &%.3f &%.3f &%.3f &%.3f& \\textit{size} \\\\ \\midrule\n',mat1(3,1),mat1(3,2),mat1(3,3),mat1(3,4),mat1(3,5),mat1(3,6));


% gamma

fprintf(FID,'\\multirow{4}{*}{$\\beta_2=5$}& %.3f & %.3f &%.3f &%.3f &%.3f &%.3f&\\textit{mean bias} \\\\ \n',mat1(5,1),mat1(5,2),mat1(5,3),mat1(5,4),mat1(5,5),mat1(5,6));

fprintf(FID,'&(%.3f )&(%.3f )&(%.3f )&(%.3f )&(%.3f )&(%.3f )&\\textit{std}\\\\ \n',mat1(6,1),mat1(6,2),mat1(6,3),mat1(6,4),mat1(6,5),mat1(6,6));

fprintf(FID,'& %.3f & %.3f &%.3f &%.3f &%.3f &%.3f&\\textit{size} \\\\\\midrule \n',mat1(7,1),mat1(7,2),mat1(7,3),mat1(7,4),mat1(7,5),mat1(7,6));


% delta
 

fprintf(FID,'\\multirow{4}{*}{$\\beta_3=5$}& %.3f & %.3f &%.3f& %.3f &%.3f &%.3f &\\textit{mean bias} \\\\ \n',mat1(9,1),mat1(9,2),mat1(9,3),mat1(9,4),mat1(9,5),mat1(9,6));

fprintf(FID,'&(%.3f )&(%.3f )&(%.3f )&(%.3f )&(%.3f )&(%.3f )&\\textit{std}\\\\ \n',mat1(10,1),mat1(10,2),mat1(10,3),mat1(10,4),mat1(10,5),mat1(10,6));

fprintf(FID,'& %.3f & %.3f &%.3f &%.3f &%.3f &%.3f&\\textit{size} \\\\\\hline \n',mat1(11,1),mat1(11,2),mat1(11,3),mat1(11,4),mat1(11,5),mat1(11,6));
...
fprintf(FID,'\\item CF - control function. $(0)$ - none, $(1)$ - $\\hat{h}(\\widehat{deg}_i,x_{2i})$, $(2)$ - $h(a_i)$. \n');
fprintf(FID,'\\item $K=%.0f$, $\\sigma_\\varepsilon=%.1f$ \n',Kn,sigma_e);
fprintf(FID,'\\item $h(a)=\\sin (\\kappa a_i)$ with $\\kappa=$%.0f.\n',kappa);
fprintf(FID,'\\item Average network statistics: density$=%.3f$, min degree$=%.3f$, max degree$=%.3f$ \n', des(1,1),des(1,6), des(1,7));
